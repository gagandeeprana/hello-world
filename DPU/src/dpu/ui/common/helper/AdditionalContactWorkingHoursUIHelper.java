...
public class AdditionalContactWorkingHoursUIHelper {
    ...
    public static Map<AdditionalContactBean, List<WorkingHoursAdditionalContactBean>> mapWorkingHours = new HashMap<>();
    ...
    public void showData(List<WorkingHoursAdditionalContactBean> listOfWorkHours) {
