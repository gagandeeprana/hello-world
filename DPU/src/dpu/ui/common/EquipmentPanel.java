...
public class EquipmentPanel extends javax.swing.JPanel {
    ...
    /**
     * S
     * Creates new form TestEquipment
     */
    EquipmentUIHelper equipmentUIHelper = null;
    EquipmentDAO equipmentDAO = null;

    public EquipmentPanel() {
        initComponents();
        equipmentUIHelper = new EquipmentUIHelper();
        equipmentDAO = new EquipmentDAOImpl();
        EquipmentUIHelper.lstEquipments = equipmentDAO.getAllEquipments(EquipmentPanel.txtSearch.getText());
        equipmentUIHelper.generateTable();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        EquipmentUIHelper.addUpdateFlag = "add";
        AddEquipmentFrame addEquipmentFrame = new AddEquipmentFrame();
        addEquipmentFrame.setVisible(true);
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int equipmentIdToBeDeleted = EquipmentUIHelper.lstEquipments.get(tblEquipment.getSelectedRow()).getEquipmentId();
        String msg = equipmentUIHelper.delete(equipmentIdToBeDeleted);
        JOptionPane.showMessageDialog(null, msg);
    }//GEN-LAST:event_btnDeleteActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        EquipmentBean equipmentBean = EquipmentUIHelper.lstEquipments.get(tblEquipment.getSelectedRow());
        EquipmentUIHelper.equipmentId = equipmentBean.getEquipmentId();
        EquipmentUIHelper.addUpdateFlag = "update";
        AddEquipmentFrame addEquipmentFrame = new AddEquipmentFrame(equipmentBean);
        addEquipmentFrame.setVisible(true);
    }//GEN-LAST:event_btnUpdateActionPerformed

    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        JasperReportGenerator.generateReport("EquipmentReport.jrxml");
