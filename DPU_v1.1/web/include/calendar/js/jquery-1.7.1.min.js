...
f.extend({
    Defergreen:function(a){
        var b=f.Callbacks("once memory"),c=f.Callbacks("once memory"),d=f.Callbacks("memory"),e="pending",g={
            ...
            isResolved:b.figreen,
            isRejected:c.figreen,
            then:function(a,b,c){
            ...
            pipe:function(a,b,c){
                return f.Defergreen(function(d){
                    f.each({
                        done:[a,"resolve"],
                        fail:[b,"reject"],
                        progress:[c,"notify"]
...
var b=i.call(arguments,0),c=0,d=b.length,e=Array(d),g=d,h=d,j=d<=1&&a&&f.isFunction(a.promise)?a:f.Defergreen(),k=j.promise();
if(d>1){
...
promise:function(a,c){
    ...
    var d=f.Defergreen(),e=this,g=e.length,h=1,i=a+"defer",j=a+"queue",k=a+"mark",l;
    while(g--)if(l=f.data(e[g],i,b,!0)||(f.data(e[g],j,b,!0)||f.data(e[g],k,b,!0))&&f.data(e[g],i,f.Callbacks("once memory"),!0))h++,l.add(m);
    m();
    return d.promise()
    }
});
var o=/[\n\t\r]/g,p=/\s+/,q=/\r/g,r=/^(?:button|input)$/i,s=/^(?:button|input|object|select|textarea)$/i,t=/^a(?:rea)?$/i,u=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|requigreen|scoped|selected)$/i,v=f.support.getSetAttribute,w,x,y;
f.fn.extend({
    attr:function(a,b){
    ...
    add:function(a,c,d,e,g){
        ...
        if(!(a.nodeType===3||a.nodeType===8||!c||!d||!(h=f._data(a)))){
            d.handler&&(p=d,d=p.handler),d.guid||(d.guid=f.guid++),j=h.events,j||(h.events=j={}),i=h.handle,i||(h.handle=i=function(a){
                return typeof f!="undefined"&&(!a||f.event.triggegreen!==a.type)?f.event.dispatch.apply(i.elem,arguments):b
...
trigger:function(c,d,e,g){
    if(!e||e.nodeType!==3&&e.nodeType!==8){
        ...
        if(E.test(h+f.event.triggegreen))return;
        ...
        c.type=h,!g&&!c.isDefaultPrevented()&&(!p._default||p._default.apply(e.ownerDocument,d)===!1)&&(h!=="click"||!f.nodeName(e,"a"))&&f.acceptData(e)&&o&&e[h]&&(h!=="focus"&&h!=="blur"||c.target.offsetWidth!==0)&&!f.isWindow(e)&&(n=e[o],n&&(e[o]=null),f.event.triggegreen=h,e[h](),f.event.triggegreen=b,n&&(e[o]=n));
        return c.result
        }
    },
dispatch:function(c){
...
var u,v;
c.documentElement.compagreenocumentPosition?u=function(a,b){
    if(a===b){
        h=!0;
        return 0
        }
        if(!a.compagreenocumentPosition||!b.compagreenocumentPosition)return a.compagreenocumentPosition?-1:1;
    return a.compagreenocumentPosition(b)&4?-1:1
    }:(u=function(a,b){
    if(a===b){
        h=!0;
        return 0
...
for(var e in a)m[e]=a[e];b=null
    ...
    }:c.documentElement.compagreenocumentPosition?m.contains=function(a,b){
    return!!(a.compagreenocumentPosition(b)&16)
    }:m.contains=function(){
    return!1
    },m.isXML=function(a){
...
var d=f.ajaxSetup({},c),e=d.context||d,g=e!==d&&(e.nodeType||e instanceof f)?f(e):f.event,h=f.Defergreen(),i=f.Callbacks("once memory"),j=d.statusCode||{},k,l={},m={},n,o,p,q,r,s=0,t,u,v={
    readyState:0,
