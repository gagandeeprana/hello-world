...
import com.jiqa.model.Question;
...
//				return helperUtil.getSuccessJSONString(questionAddedCode, questionAddedMessage);
	...
	@Override
	public Object softDeleteQuestion(@PathVariable("status") int status, @PathVariable("id") int id) {
		Object obj = null;
	...
	@Override
	public Object getQuestionInfoById(@PathVariable("questionId") int id) {
		String json = null;
		try {
